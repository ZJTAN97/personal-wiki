...
1. [`useDeferredValue`](/docs/react/react-hooks/use-deferred-value)
2. [`useTransition`](/docs/react/react-hooks/use-transition)
3. `<Suspense />`

Do refer to the respective hooks guide on in-depth how it works
